...
public class ShowLow extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.low_alert);
		botonAsistencia = (Button) findViewById(R.id.asistenciaGeenBtn);
		//comportamiento para que envie las coordenadas por medio de sms
		 ...
		 botonAsistencia.setOnClickListener(new OnClickListener() {
